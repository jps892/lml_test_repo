...
@add_start_docstrings(
    ...
    in a document. This is for tasks such as linking in [XFUN](https://github.com/doc-analysis/XFUND) (a biaffine
    attention layer ontop of the text part of the hidden states to compute start and end of both a relation key
    and a relation value.
    """,
    LAYOUTLMV2_START_DOCSTRING,
)
